...
abstract class Projectile {
	...
	canApplyTo(target: Player) {
		//if the projectile is generated by player and traget is invisible, don`t apply the projectile
		if(this.sourcePlayer && target.effects.has(EFFECT.INVISIBILITY)) return false
