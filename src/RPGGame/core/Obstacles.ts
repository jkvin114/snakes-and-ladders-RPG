...
import { Damage,PercentDamage } from "./Damage"
...
export namespace ObstacleHelper {
		...
		try {
			switch (obs) {
				...
				case 11:
					...
					break
				case 12:
					player.effects.apply(EFFECT.FARSIGHT, 1)
					player.effects.applySpecial(
						EffectFactory.create(EFFECT.MAGIC_CASTLE_ADAMAGE)?.addData(player.ability.getMagicCastleDamage()),
						SpecialEffect.OBSTACLE.MAGIC_CASTLE_ADAMAGE.name
					)
					// player.message(player.name + ": skill range x3, additional damage 30")
					break
				case 13:
					player.effects.apply(EFFECT.ROOT, 1)
				...
				case 15:
					...
					break
				case 16:
					player.effects.apply(EFFECT.SLOW, 1)
				...
				case 21:
					...
					break
				case 22:
					player.effects.apply(EFFECT.ANNUITY, perma)
					break
				case 23:
					player.inven.takeMoney(30)
				...
				case 24:
					...
					player.effects.apply(EFFECT.SHIELD, 99999)
					player.effects.apply(EFFECT.INVISIBILITY, 1)
					player.heal(70)
					break
				case 25:
					player.effects.apply(EFFECT.SHIELD, perma)
					break
				case 26:
				...
				case 28:
					player.effects.apply(EFFECT.ROOT, 1)
					player.effects.apply(EFFECT.SLOW, 2)
					player.obstacleEffect("web")
				...
				case 31:
					...
					.getTotal(player.MaxHP,player.HP),"explode")
					player.effects.apply(EFFECT.RADI, 1)
					break
				case 32:
					player.effects.apply(EFFECT.RADI, 1)
					break
				...
				case 35:
					...
					player.effects.apply(EFFECT.SPEED, 4)
					break
				case 36:
					if (!isForceMoved) {
				...
				case 38:
					...
					break
				case 39:
					player.effects.apply(EFFECT.DOUBLEDICE, 1)
					break
				case 40:
					player.effects.apply(EFFECT.BACKDICE, 1)
					break
				case 41:
					player.effects.apply(EFFECT.ROOT, 1)
					player.obstacleEffect("web")
				...
				case 42:
					...
					break
				case 43:
					player.effects.apply(EFFECT.POISON, 3)
					break
				case 44:
					player.doObstacleDamage(40,"knifeslash")
					break
				case 45:
					player.effects.apply(EFFECT.BLIND, 3)
					break
				case 46:
					player.effects.apply(EFFECT.SLOW, 1)
				...
				case 49:
					...
					break
				case 50:
					player.effects.apply(EFFECT.IGNITE, 3)
					player.doObstacleDamage(30,"knifeslash")
				...
				case 58:
					...
					break
				case 59:
					player.effects.apply(EFFECT.SPEED, 3)
					break
				case 60:
					player.effects.apply(EFFECT.IGNITE, 3)
				...
				case 63:
					...
					break
				case 64:
					player.effects.apply(EFFECT.PRIVATE_LOAN, 2)
					break
				case 65:
					...
					break
				case 66:
					player.effects.apply(EFFECT.ANNUITY_LOTTERY, perma)
					break
				case 67: //coin store
					if (player.effects.has(EFFECT.PRIVATE_LOAN)) {
				...
				case 71:
					...
					break
				case 72:
					player.effects.apply(EFFECT.CURSE, 2)
					break
				case 73:
	...
	export const kidnap=function (player: Player, result: boolean) {
		if (result) {
			player.effects.apply(EFFECT.ROOT, 2)
		} else {
	...
	export const trial=function(player: Player, num: number) {
		...
		switch (num) {
			...
			case 4:
				...
				player.effects.apply(EFFECT.GROUNGING, 1)
	...
	export const casino=function (player: Player, num: number) {
		switch (num) {
			...
			case 1:
				...
				break
			case 2:
				player.effects.apply(EFFECT.SPEED, 2)
				break
			case 3:
				player.doObstacleDamage(Math.floor(player.HP / 2),"stab")
