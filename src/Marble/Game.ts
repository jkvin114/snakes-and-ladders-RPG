...
class MarbleGame {
	...
	constructor(players: BaseProtoPlayer[], rname: string, isTeam: boolean, map: number) {
		this.isTeam = isTeam
		this.rname = rname
	...
	isAI(turn:number):boolean{
		return this.mediator.pOfTurn(turn).AI
	}
	...
	getResultStat(windata:GameOverAction):GameResultStat{
		return {
			winner:windata.turn,
