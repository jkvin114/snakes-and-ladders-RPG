...
export class AbilityStorage {
    private static readonly ONCE_IN_A_TURN=new Set([
    ...
    private readonly turnLimitAbilites:Set<ABILITY_NAME>
    ...
    constructor(){
        ...
        this.turnLimitAbilites=new Set<ABILITY_NAME>()
    }
    onTurnStart(){
        this.turnLimitAbilites.clear()
    }
